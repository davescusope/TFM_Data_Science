...
This mechanism is a real time one and quite complex so we will not go deeper about it. what we will do is staying with the important thing : **all technologies are paid at the same price, but have different margins "revenue - costs"**
