...
-A. Every point has the same weight to the final mark ( eventhough we all know that not all of them are the same)
-B. I will evaluate them ONLY for the application on this project, and not for it's possibilities out of this frame 
