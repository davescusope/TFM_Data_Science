...
Finally, it is worth noting the fact that both, costs and revenues, are expected to be dependent on production more or less directly

That is, higher production is expected to produce higher costs ( Obviously). Throughout the TFM we will be able to verify the nature and intensity of this collinearity since, if it does not exist, our model will not be able to predict successfully because production will be the major input.
