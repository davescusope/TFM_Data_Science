...
This approach follows the previously highlighted idea that I wanted to apply as much different tools as possible (keeping the common sense) for achieving the objective.
